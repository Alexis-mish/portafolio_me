  ...
  return (
    <section id="projects" className="section projects" ref={sectionRef as React.RefObject<HTMLElement>}>
      <div className="container">
        <div className="section-label fade-in-up">{t.projects.label}</div>
        <h2 className="projects__title fade-in-up">
          {t.projects.titleBefore}<span className="gradient-text">{t.projects.titleHighlight}</span>
        </h2>
        ...
        <div className="projects__grid fade-in-up">
          {PROJECTS.map((proj) => {
            const trans = t.projects.items[proj.id as keyof typeof t.projects.items];
            const displaySubtitle = trans?.subtitle || proj.subtitle;
            const displayDesc = trans?.description || proj.description;
            ...
            return (
              ...
              >
                ...
                <div className="project-card__banner" style={{ background: proj.gradient }}>
                  {proj.featured && <span className="project-badge">{t.projects.badgeFeatured}</span>}
                ...
                <div className="project-card__body">
                  <div>
                    ...
                    <p className="project-card__subtitle">{displaySubtitle}</p>
                  </div>
